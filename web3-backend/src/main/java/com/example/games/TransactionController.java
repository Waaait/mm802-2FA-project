...
//    }
    ...
    public ResponseEntity<Transaction> createTransaction(@RequestBody CreateTransactionRequest reqBody) {
        return new ResponseEntity<Transaction>(transactionService.createTransaction(reqBody.getClientId(), reqBody.getUserAddress(),  reqBody.getTo(), reqBody.getContractAddress(), reqBody.getMetaData()), HttpStatus.CREATED);
    }
